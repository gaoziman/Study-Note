...
```java
复制代码1234567JAVApublic class MemoryLeak {
...
```java
复制代码1234567891011121314JAVApublic static void main(String[] args) {
    try{
...
```java
复制代码1234567JAVApublic class UsingRandom {
    private String msg;
...
```java
复制代码12345678910111213141516171819202122232425262728293031323334353637383940414243444546474849505152535455565758596061JAVA/**
 * 例1
 */
...
复制代码12345678910111213141516171819202122232425262728293031323334353637383940414243444546474849505152535455565758JAVA/**
 * 例2
 */
...
```java
复制代码12345678910111213141516171819202122232425262728293031323334353637383940414243444546474849505152535455565758JAVApublic class MapTest {
...
```java
复制代码12345678910111213141516171819202122232425JAVApublic class Stack {
...
```java
复制代码1234567JAVApublic Object pop() {
    if (size == 0)
        throw new EmptyStackException();
