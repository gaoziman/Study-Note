...
```java
复制代码1234JAVApublic final class String implements java.io.Serializable, Comparable<String>, CharSequence {
    @Stable
...
```java
复制代码1234567891011121314151617181920212223JAVA@Test
public void test1() {
...
```java
复制代码123456789101112JAVAclass Memory {
...
```java
复制代码123456789JAVA  public static void test1() {
      // 都是常量，前端编译期会进行代码优化
...
```java
复制代码123456789101112131415161718192021JAVApublic static void test5() {
    String s1 = "javaEE";
    String s2 = "hadoop";
...
```java
复制代码123456789101112JAVApublic void test6(){
    String s0 = "beijing";
    String s1 = "bei";
    String s2 = "jing";
    String s3 = s1 + s2;
...
```java
复制代码1234567JAVApublic void test3(){
    String s1 = "a";
    String s2 = "b";
    String s3 = "ab";
    String s4 = s1 + s2;
...
```shell
复制代码123456789101112131415161718192021222324SHELL 0 ldc #2 <a>
 2 astore_1
 3 ldc #3 <b>
 5 astore_2
 6 ldc #4 <ab>
...
复制代码
1
JAVAString myInfo = new string("I love atguigu").intern();
```
...
复制代码
1
JAVApublic class StringGCTest {    /**     * -Xms15m -Xmx15m -XX:+PrintGCDetails     */    public static void main(String[] args) {                for (int i = 0; i < 100000; i++) {            String.valueOf(i).intern();        }    }}
```
...
SHELL# 开启String去重，默认是不开启的，需要手动开启。 UseStringDeduplication(bool)  # 打印详细的去重统计信息 PrintStringDe
```