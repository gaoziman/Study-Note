...
```java
复制代码12JAVAError: A JNI error has occurred, please check your installation and try again
...
```java
复制代码12345JAVAConstantValue_attribute{
	u2 attribute_name_index;
	u4 attribute_length;
...
```java
复制代码1234JAVADeprecated_attribute{
	u2 attribute_name_index;
	u4 attribute_length;
}
```
...
```java
复制代码12345678910JAVA// LineNumberTable属性表结构：
...
```java
复制代码12345678910111213JAVA// LocalVariableTable属性表结构：
